---
title: "Курсовая работа Алексеева Антона"
output:
  html_document:
    code_folding: hide
    df_print: paged
...
data = read_excel("D:/.../3 курс/курсовая/2010/готовое/числ по национальностям по суб РЕДАЧ.xlsx", col_names = T) %>% arrange(region)
...
```{r data2}
data2 = read_excel("D:/.../3 курс/курсовая/2015/эк активные.xlsx", col_names = T)
...
```{r data3}
data0 = read_excel("D:/.../3 курс/курсовая/2002/национальность.xls", col_names = T)
...
Для таблицы языков
```{r for_FRAC_lang}
df_full = read_excel("D:/.../3 курс/курсовая/2010/сто таблиц про языки/Pub-04-09-1.xlsx")
...
i = 2
for (i in clear_list){
    name = paste0("D:/.../3 курс/курсовая/2010/сто таблиц про языки/Pub-04-09-", deparse(i+0), ".xlsx")
    df = read_excel(name)
...
Для происхождения
```{r FRAC_origin}
data_origin_reg = read_excel("D:/.../3 курс/курсовая/2010/готовое/регионы и страны происхождения по суб.xlsx", col_names = T, sheet = "регионы (2)")
data_origin_country = read_excel("D:/.../3 курс/курсовая/2010/готовое/регионы и страны происхождения по суб.xlsx", col_names = T, sheet = "страны (2)")
...
```{r root_population}
data_root = read_excel("D:/.../3 курс/курсовая/2010/готовое/регионы и страны происхождения по суб.xlsx", col_names = T, sheet = "для коренного")
...
```{r urban_population}
df_urban = read_excel("D:/.../3 курс/курсовая/2010/готовое/доля городского насел по суб.xlsx", col_names = T)
...
df_budget = read_excel("D:/.../3 курс/курсовая/2010/готовое/расходы бюджета по суб.xlsx", col_names = T)
...
df_active = read_excel("D:/.../3 курс/курсовая/2010/готовое/трудовые ресы по субъектам.xlsx", col_names = T)
...
```{r migration_growth}
df_migr = read_excel("D:/.../3 курс/курсовая/2010/готовое/миграционный прирост.xlsx", col_names = T)
...
```{r FRAC_origin15}
data_origin_reg15 = read_excel("D:/.../3 курс/курсовая/2015/происхождение+коренное.xlsx", col_names = T, sheet = "по_региону")
data_origin_country15 = read_excel("D:/.../3 курс/курсовая/2015/происхождение+коренное.xlsx", col_names = T, sheet = "по_стране")
...
Для национальности
```{r}
data_nation2015 = read_excel("D:/.../3 курс/курсовая/2015/национальность по суб+городское.xlsx", col_names = T, sheet = "национальность") %>% arrange(region)
...
Для языков
```{r}
data_lang = read_excel("D:/.../3 курс/курсовая/2015/родной язык по суб.xlsx", col_names = T) %>% arrange(region)
...
data_root = read_excel("D:/.../3 курс/курсовая/2015/происхождение+коренное.xlsx", col_names = T, sheet = "коренное_насел(вместе_с_иностр)")
...
data_urban = read_excel("D:/.../3 курс/курсовая/2015/национальность по суб+городское.xlsx", col_names = T, sheet = "городское")
...
df_budget = read_excel("D:/.../3 курс/курсовая/2015/расходы бюджета по суб.xlsx", col_names = T, sheet="расходы руб")
...
```{r migration2015}
data_migr = read_excel("D:/.../3 курс/курсовая/2015/миграционный прирост.xlsx", col_names = T)
...
Для происхождения
```{r}
data_origin_reg02 = read_excel("D:/.../3 курс/курсовая/2002/происхождение+коренное.xls", col_names = T, sheet = "по_региону")
data_origin_country02 = read_excel("D:/.../3 курс/курсовая/2002/происхождение+коренное.xls", col_names = T, sheet = "по_стране")
...
Остальное
```{r}
df_resid = read_excel("D:/.../3 курс/курсовая/2002/2002 от алены.xlsx", col_names = T, sheet = "загрузка")
...
ВРП
```{r GDP_na_dushu}
df_VRP = read_excel("D:/.../3 курс/курсовая/общее/ВРП_на_душу98-19.xlsx", col_names = T)
...
```{r population}
df_popul = read_excel("D:/.../3 курс/курсовая/общее/численность населения по суб 1991-2019.xlsx", col_names = T)
...
df_square = read_excel("D:/.../3 курс/курсовая/общее/площадь регионов.xlsx", col_names = T)
...
df_tech_innov = read_excel("D:/.../3 курс/курсовая/общее/затраты на технологич инновац по суб.xlsx", col_names = T)
...
```{r osnovnoy_kapital}
df_osn_kap = read_excel("D:/.../3 курс/курсовая/общее/инвест в основной капитал на душу по суб.xlsx", col_names = T)
...
df_scientists = read_excel("D:/.../3 курс/курсовая/общее/численность ученых по суб.xlsx", col_names = T)
...
Инфляция
```{r inflation}
df_CPI = read_excel("D:/.../3 курс/курсовая/общее/ипц по субъектам.xlsx", col_names = T)
...
```{r education}
df_educ = read_excel("D:/.../3 курс/курсовая/общее/образование по субъектам.xlsx", col_names = T)
...
```{r pollution}
df_pollution = read_excel("D:/.../3 курс/курсовая/общее/инструменты.xlsx", sheet = "загрязнение", col_names = T)
...
```{r roads}
df_roads = read_excel("D:/.../3 курс/курсовая/общее/инструменты.xlsx", sheet = "плотность дорог", col_names = T)
...
```{r house}
df_house = read_excel("D:/.../3 курс/курсовая/общее/инструменты.xlsx", sheet = "цена жилья", col_names = T)
...
```{r final_export}
write_excel_csv2(df_full, "D:/.../3 курс/курсовая/final_df.csv", col_names = TRUE)
foreign::write.dta(df_full, "D:/.../3 курс/курсовая/final_df.dta")
```

```{r year-dfs}
df_02 = df_full %>% filter(year == 2002)
foreign::write.dta(df_02, "D:/.../3 курс/курсовая/df_02.dta")

df_10 = df_full %>% filter(year == 2010)
foreign::write.dta(df_10, "D:/.../3 курс/курсовая/df_10.dta")

df_15 = df_full %>% filter(year == 2015)
foreign::write.dta(df_15, "D:/.../3 курс/курсовая/df_15.dta")


df_02_10 = df_full %>% filter(year %in% c(2002, 2010))
foreign::write.dta(df_02_10, "D:/.../3 курс/курсовая/df_02_10.dta")

df_10_15 = df_full %>% filter(year %in% c(2010, 2015))
foreign::write.dta(df_10_15, "D:/.../3 курс/курсовая/df_10_15.dta")
```

```{r bez_gorodov}
foreign::write.dta(filter(df_full, region != "г. Москва" & region != "г. Санкт-Петербург"), "D:/.../3 курс/курсовая/final_dfbez.dta")

df_02bez = df_full %>% filter(year == 2002) %>% filter(region != "г. Москва" & region != "г. Санкт-Петербург")
foreign::write.dta(df_02bez, "D:/.../3 курс/курсовая/df_02bez.dta")

df_10bez = df_full %>% filter(year == 2010) %>% filter(region != "г. Москва" & region != "г. Санкт-Петербург")
foreign::write.dta(df_10bez, "D:/.../3 курс/курсовая/df_10bez.dta")

df_15bez = df_full %>% filter(year == 2015) %>% filter(region != "г. Москва" & region != "г. Санкт-Петербург")
foreign::write.dta(df_15bez, "D:/.../3 курс/курсовая/df_15bez.dta")


df_02_10bez = df_full %>% filter(year %in% c(2002, 2010)) %>% filter(region != "г. Москва" & region != "г. Санкт-Петербург")
foreign::write.dta(df_02_10bez, "D:/.../3 курс/курсовая/df_02_10bez.dta")

df_10_15bez = df_full %>% filter(year %in% c(2010, 2015)) %>% filter(region != "г. Москва" & region != "г. Санкт-Петербург")
foreign::write.dta(df_10_15bez, "D:/.../3 курс/курсовая/df_10_15bez.dta")

# для инструментов
foreign::write.dta(filter(df_full, region != "г. Москва" & region != "г. Санкт-Петербург" & region != "Еврейская автономная область" & region != "Чукотский автономный округ"), "D:/.../3 курс/курсовая/final_df_instr.dta")
```
...
# запускать весь чанк!
wwidth = 900
graph_path = "D:/.../3 курс/курсовая/графики/"
